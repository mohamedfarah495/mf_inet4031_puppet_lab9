...
user { 'user05':
  ...
  shell      => '/bin/bash',
  password   => '$6$xyz$fvqDLmx0wy4TlDQ2f1XgA0LTJJAecH9QVTiHNFFhLVE/PYAaCbYXgq0RdpPmWD9q36FjqhQAB3cC7DpV82r2f1',
  groups     => 'group02',
  managehome => true,
}
...
user { 'user07':
  ...
  shell      => '/bin/bash',
  password   => '$6$xyz$zLj5PnjLdM6pveJoYYpAfowmR81rqqtgs9Xh5ikn.oRf8GxSSR4XOo1iE1lWu7rhkUrS20.oNBN1NkWRW5Tb60',
  managehome => true,
}
